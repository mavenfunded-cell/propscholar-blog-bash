...
const handler = async (req: Request): Promise<Response> => {
  ...
  try {
    ...
    if (!isInternalNote) {
      ...
      // Premium email template with PropScholar branding
      const emailHtml = `
        <!DOCTYPE html>
        <html lang="en">
        <head>
                ...
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="600" style="max-width: 600px; margin: 0 auto;">
                  ...
                  <tr>
                    <td style="text-align: center; padding-bottom: 32px;">
                      <img src="https://propscholar.space/propscholar-logo.png" alt="PropScholar" width="180" style="max-width: 180px; height: auto;" />
                    </td>
                  </tr>
                  ...
                  <tr>
                    <td>
                      <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="background: linear-gradient(145deg, #13131a 0%, #1a1a24 100%); border-radius: 20px; border: 1px solid rgba(139, 92, 246, 0.2); box-shadow: 0 25px 50px -12px rgba(0, 0, 0, 0.5);">
                        
                        <!-- Purple Accent Bar -->
                        <tr>
                          <td style="height: 4px; background: linear-gradient(90deg, #8b5cf6, #a78bfa, #c4b5fd, #a78bfa, #8b5cf6); border-radius: 20px 20px 0 0;"></td>
                        </tr>
                        ...
                        <tr>
                          <td style="padding: 32px 40px 24px 40px;">
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                              <tr>
                                <td>
                                  <span style="display: inline-block; background: linear-gradient(135deg, rgba(139, 92, 246, 0.2) 0%, rgba(168, 85, 247, 0.2) 100%); border: 1px solid rgba(139, 92, 246, 0.3); border-radius: 20px; padding: 6px 14px; font-size: 12px; color: #a78bfa; font-weight: 600; letter-spacing: 0.5px;">
                        ...
                        <tr>
                          <td style="padding: 0 40px 32px 40px;">
                            <div style="background: rgba(255, 255, 255, 0.03); border-radius: 12px; padding: 24px; border: 1px solid rgba(255, 255, 255, 0.05);">
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                              <tr>
                                <td style="text-align: center;">
                                  ...
                                  <div style="display: inline-block; background: linear-gradient(135deg, #8b5cf6 0%, #7c3aed 100%); border-radius: 10px; padding: 14px 28px;">
                                    <span style="color: #ffffff; font-size: 14px; font-weight: 600; letter-spacing: 0.3px;">↩️ Reply to Continue</span>
                                  </div>
                                </td>
                              </tr>
                            </table>
                      ...
                      <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                        <tr>
                          <td style="padding-bottom: 16px;">
                            <span style="color: #64748b; font-size: 13px;">Powered by</span>
                            <span style="color: #a78bfa; font-size: 13px; font-weight: 600;"> PropScholar</span>
                          </td>
                        </tr>
                        <tr>
                          <td>
                            <p style="margin: 0; color: #475569; font-size: 12px; line-height: 1.5;">
                              © ${new Date().getFullYear()} PropScholar. All rights reserved.<br>
                              <a href="https://propscholar.space" style="color: #8b5cf6; text-decoration: none;">propscholar.space</a>
                            </p>
                          </td>
                        </tr>
                      </table>
