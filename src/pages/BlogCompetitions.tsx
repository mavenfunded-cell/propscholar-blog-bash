...
import { Calendar, Clock, ArrowRight, ArrowLeft, XCircle, PenTool } from 'lucide-react';
        ...
        {events.length === 0 && !loading && (
          <section className="py-20">
            <div className="container mx-auto px-4 text-center">
              ...
              <h3 className="text-xl font-semibold mb-2 text-foreground">No Blog Contests Yet</h3>
              <p className="text-muted-foreground">Check back soon for upcoming blog writing contests.</p>
            </div>
          </section>
        )}
