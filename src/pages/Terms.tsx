    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="prose prose-invert max-w-none space-y-8 text-muted-foreground">
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mb-4">3. Submission Guidelines</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mb-4">5. Judging Criteria</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mb-4">7. Disqualification</h2>
            <p>
          ...
          <section>
            ...
            <p>
              ...
              <a href="https://propscholar.com" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">
                propscholar.com
              </a>.
            </p>
          </section>
