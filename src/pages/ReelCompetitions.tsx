              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {activeEvents.map((event, index) => (
                  <Link key={event.id} to={`/reels/${event.slug}`}>
                    <Card className="h-full hover:border-purple-500/30 hover:shadow-[0_0_30px_hsla(270,91%,60%,0.15)] transition-all duration-300 animate-slide-up group bg-card/80 backdrop-blur-sm"
