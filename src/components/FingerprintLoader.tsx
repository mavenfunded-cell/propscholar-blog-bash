  ...
  return (
    <>
      <style>{`
        ...
        .active .fingerprint-active-svg .odd {
          stroke-dasharray: 50px 50px;
          transition: stroke-dasharray 2000ms 1500ms;
        }
        .active .fingerprint-active-svg .even {
          stroke-dashoffset: 0px;
      ...
      `}</style>
      <div ref={containerRef} className="fingerprint-container">
        <span className="fingerprint-text">VERIFY</span>
        ...
        <svg className="fingerprint fingerprint-active-svg" xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 100 100">
          <g className="fingerprint-out" fill="none" strokeWidth="2" strokeLinecap="round">
            <path className="odd" d="m 25.117139,57.142857 c 0,0 -1.968558,-7.660465 -0.643619,-13.149003 1.324939,-5.488538 4.659682,-8.994751 4.659682,-8.994751" />
            <path className="odd" d="m 31.925369,31.477584 c 0,0 2.153609,-2.934998 9.074971,-5.105078 6.921362,-2.17008 11.799844,-0.618718 11.799844,-0.618718" />
            <path className="odd" d="m 57.131213,26.814448 c 0,0 5.127709,1.731228 9.899495,7.513009 4.771786,5.781781 4.772971,12.109204 4.772971,12.109204" />
        ...
        <svg className="ok" xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 100 100">
          <path d="M34.912 50.75l10.89 10.125L67 36.75" fill="none" stroke="hsl(var(--primary))" strokeWidth="6" />
        </svg>
      </div>
    </>
  );
